...
**DontSoundLikeALLM** - Never use LLMogisms — un-grammatical/space-padded emdashes, unicode arrows, "the X is [not] Y", "X + Y + Z", "N-layer", "load-bearing", "honest", "invariant", "framing", "shipped", "land", "shapes", "the key insight", "why X matters/happened", "what makes the Subject Verb", "the Subject Verbs the Object [never the Counterexample]", "X, not Y", "the X, the Y, the Z", "lists, of, three". (Yes, this file is actually full of such shibboleths.)
